...
import com.test.android75_contentprovider_practice1.databinding.ActivityMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        activityMainBinding.run{
            buttonSelectData.setOnClickListener {
                ...
                val dh = DBHelper(this@MainActivity)

                val cursor = dh.writableDatabase.rawQuery(sql, null)
